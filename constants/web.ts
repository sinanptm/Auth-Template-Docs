...
export default AdminLayout;`,
      description: "Admin layout with authentication guard that checks admin authentication status and redirects unauthorized users, with hydration handling for SSR compatibility.",
    },
  },
  components: {
    name: "components",
    purpose: "Modular React Component Architecture with shadcn/ui",
    description: "Comprehensive component library organized by feature and complexity. Built on shadcn/ui and Radix UI primitives with custom form elements, authentication components, and layout components. Features atomic design principles with reusable form elements that integrate react-hook-form with Zod validation.",
...
export default memo(CustomInput);`,
      description: "Custom input component with password visibility toggle, error handling, and accessibility features, extending shadcn/ui Input with form validation integration.",
    },
  },
  hooks: {
    name: "hooks",
    purpose: "Custom React Hooks with TanStack Query & Zustand",
    description: "Advanced custom hooks architecture featuring TanStack Query for server state management and Zustand for client state. Includes API hooks with automatic token refresh, authentication state management with localStorage persistence, and utility hooks for loading states and error handling.",
...
export default useAuthUser;`,
      description: "Zustand authentication store with SSR-safe hydration, localStorage persistence, and automatic token management for seamless user authentication state.",
    },
  },
  lib: {
    name: "lib",
    purpose: "Core Utilities with Axios & Zod Integration",
    description: "Essential utility library featuring Axios API client with automatic token refresh, Zod validation schemas, utility functions for authentication, and shared configurations. Includes sophisticated error handling, request/response interceptors, and type-safe API wrapper functions.",
...
export default createApiInstance;`,
      description: "Sophisticated Axios instance factory with automatic token refresh, role-based authentication, and comprehensive error handling for seamless API communication.",
    },
  },
  types: {
    name: "types",
    purpose: "Comprehensive TypeScript Type System",
    description: "Extensive TypeScript type definitions covering API routes, form validation, component props, and state management. Features discriminated unions, generic types, and utility types that ensure type safety across the entire application with clear contracts between different layers.",
...
export interface FormFieldWrapperProps extends BaseFormFieldProps {
  children: (id: string, describedBy: string | undefined) => React.ReactNode;
      ...
      description: "Comprehensive prop interfaces for form components with optional configurations, error handling, and flexible customization options for authentication flows.",
    },
  },
  styles: {
    name: "styles",
    purpose: "Tailwind CSS v4 with Custom Design System",
    description: "Modern styling architecture using Tailwind CSS v4 with custom CSS properties, dark mode support, and a comprehensive design system. Features custom animations, color schemes with OKLCH color space, and responsive design utilities with accessibility considerations.",
  ...
  * {
  ...
  body {
    @apply bg-background text-foreground;
      ...
      description: "Modern Tailwind CSS v4 configuration with OKLCH color space, custom design tokens, and comprehensive theming system for consistent visual design.",
    },
  },
  config: {
    name: "config",
    purpose: "Application Configuration with Firebase Integration",
    description: "Centralized configuration management with environment variable handling, Firebase integration, and application constants. Provides type-safe configuration objects and manages different environments with proper fallbacks and validation.",
...
initializeApp(firebaseConfig);`,
      description: "Application configuration with Firebase initialization, environment variable management, and server URL configuration with development fallbacks.",
    },
  },
  constants: {
    name: "constants",
    purpose: "Application Constants & Static Values",
    description: "Centralized constants and static values used throughout the application. While not explicitly shown in the provided code, this folder would typically contain API endpoints, validation rules, UI constants, and other static data that remains unchanged during runtime.",
  ...
  public: {
    ...
    description: "Static assets served directly by Next.js including images, icons, fonts, and other public files. Contains Google OAuth assets and other resources that need to be publicly accessible via direct URLs for SEO and performance optimization.",
